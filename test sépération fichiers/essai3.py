...
class Map(Etats):
    def __init__(self,jeu):
        ...
        "zone_Bon_minerai" : [pygame.Rect(1150,100,300,150),Bon_minerai],
        "zone_Eau" : [pygame.Rect(950,800,300,200),Eau],
        "Krabi" : [pygame.Rect(700,550,300,100),Krabi],
        "zone_Zephyr" : [pygame.Rect(1250,850,200,110),Zephyr],
        "zone_Mars" : [pygame.Rect(1250,350,300,150),Mars],
        "zone_Chaudron" : [pygame.Rect(1150,700,300,130),Chaudron],
            }
